...
var require_angular_route = __commonJS({
  "node_modules/angular-route/angular-route.js"() {
    (function(window2, angular) {
      "use strict";
      ...
      var isDefined;
      var noop;
      var ngRouteModule = angular.module("ngRoute", []).info({ angularVersion: "1.8.3" }).provider("$route", $RouteProvider).run(instantiateRoute);
            ...
            function getRedirectionData(route) {
              ...
              if (route) {
                if (route.redirectTo) {
                  ...
                  return $q.resolve($injector.invoke(route.resolveRedirectTo)).then(function(newUrl2) {
                    if (angular.isDefined(newUrl2)) {
                      data.url = newUrl2;
                      data.hasRedirection = true;
                    }
                    return data;
            ...
            function update() {
              ...
              if (angular.isDefined(template)) {
                ...
                var clone = $transclude(newScope, function(clone2) {
                  $animate.enter(clone2, null, currentElement || $element).done(function onNgViewEnter(response) {
...
var require_angular_route2 = __commonJS({
  "node_modules/angular-route/index.js"(exports, module) {
    require_angular_route();
    module.exports = "ngRoute";
  }
});
export default require_angular_route2();
