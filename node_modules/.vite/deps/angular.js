  ...
  "node_modules/angular/angular.js"() {
    (function(window2) {
          ...
          for (var j = 0, jj = keys.length; j < jj; j++) {
            ...
            if (deep && isObject(src)) {
              if (isDate(src)) {
                ...
                if (key2 !== "__proto__") {
                  if (!isObject(dst[key2])) dst[key2] = isArray(src) ? [] : {};
          ...
          if (isArray(o1)) {
            ...
            if ((length = o1.length) === o2.length) {
              for (key2 = 0; key2 < length; key2++) {
                if (!equals(o1[key2], o2[key2])) return false;
              }
              return true;
            }
          } else if (isDate(o1)) {
            ...
            keySet = createMap();
            for (key2 in o1) {
              if (key2.charAt(0) === "$" || isFunction(o1[key2])) continue;
              if (!equals(o1[key2], o2[key2])) return false;
              keySet[key2] = true;
            }
            for (key2 in o2) {
              if (!(key2 in keySet) && key2.charAt(0) !== "$" && isDefined(o2[key2]) && !isFunction(o2[key2])) return false;
            }
            return true;
          }
        }
      ...
      function angularInit(element, bootstrap2) {
        var appElement, module2, config = {};
        forEach(ngAttrPrefixes, function(prefix) {
          var name = prefix + "app";
          if (!appElement && element.hasAttribute && element.hasAttribute(name)) {
            appElement = element;
            module2 = element.getAttribute(name);
          }
        });
        forEach(ngAttrPrefixes, function(prefix) {
          var name = prefix + "app";
        ...
        if (appElement) {
          ...
          bootstrap2(appElement, module2 ? [module2] : [], config);
        }
      }
      ...
      function bindJQuery() {
        ...
        var jqName = jq();
        jQuery = isUndefined(jqName) ? window2.jQuery : (
          ...
          return function module2(name, requires, configFn) {
            ...
            return ensure(modules, name, function() {
              ...
              var moduleInstance = {
                ...
                info: function(value) {
                  if (isDefined(value)) {
                    if (!isObject(value)) throw ngMinErr2("aobj", "Argument '{0}' must be an object", "value");
                    info = value;
                    return this;
                  }
                  return info;
      ...
      var jqLiteContains = window2.Node.prototype.contains || /** @this */
      function(arg) {
      ...
      function $AnchorScrollProvider() {
        ...
        this.$get = ["$window", "$location", "$rootScope", function($window, $location, $rootScope) {
          ...
          function scroll(hash) {
            ...
            else if (elm = document2.getElementById(hash)) scrollTo(elm);
            else if (elm = getFirstAnchor(document2.getElementsByName(hash))) scrollTo(elm);
      ...
      function Browser(window3, document2, $log, $sniffer, $$taskTrackerFactory) {
        ...
        self.url = function(url, replace, state) {
          ...
          if (location !== window3.location) location = window3.location;
          if (history !== window3.history) history = window3.history;
          if (url) {
        ...
        self.onUrlChange = function(callback) {
          if (!urlChangeInit) {
            if ($sniffer.history) jqLite(window3).on("popstate", cacheStateAndFireUrlChange);
      ...
      function $CompileProvider($provide, $$sanitizeUriProvider) {
        ...
        function getDirectiveRequire(directive) {
          ...
          if (!isArray(require2) && isObject(require2)) {
            forEach(require2, function(value, key2) {
              ...
              if (!name) require2[key2] = match[0] + key2;
            });
          }
          return require2;
        }
        ...
        this.component = function registerComponent(name, options) {
          ...
          forEach(options, function(val, key2) {
            if (key2.charAt(0) === "$") {
              factory[key2] = val;
              if (isFunction(controller)) controller[key2] = val;
            }
          });
          ...
          function($injector, $interpolate, $exceptionHandler, $templateRequest, $parse, $controller, $rootScope, $sce, $animate) {
            ...
            function applyDirectivesToNode(directives, compileNode, templateAttrs, transcludeFn, jqCollection, originalReplaceDirective, preLinkFns, postLinkFns, previousCompileContext) {
              ...
              function addLinkFns(pre, post, attrStart2, attrEnd2) {
                if (pre) {
                  if (attrStart2) pre = groupElementsLinkFnWrapper(pre, attrStart2, attrEnd2);
                ...
                if (post) {
                  if (attrStart2) post = groupElementsLinkFnWrapper(post, attrStart2, attrEnd2);
            ...
            case 1:
              if (isString(search) || isNumber(search)) {
                ...
                forEach(search, function(value, key2) {
                  if (value == null) delete search[key2];
                });
                this.$$search = search;
              } else {
                throw $locationMinErr(
      ...
      function dateFilter($locale) {
        ...
        function jsonStringToDate(string) {
          ...
          if (match = string.match(R_ISO8601_STR)) {
            var date = /* @__PURE__ */ new Date(0), tzHour = 0, tzMin = 0, dateSetter = match[8] ? date.setUTCFullYear : date.setFullYear, timeSetter = match[8] ? date.setUTCHours : date.setHours;
            if (match[9]) {
        ...
        compile: function(element, attr) {
          if (!attr.href && !attr.xlinkHref) {
            return function(scope, element2) {
              if (element2[0].nodeName.toLowerCase() !== "a") return;
        ...
        if ($sniffer.hasEvent("input")) {
          ...
          element.on(
            ...
            function(event) {
              ...
              if (key2 === 91 || 15 < key2 && key2 < 19 || 37 <= key2 && key2 <= 40) return;
      ...
      var ngRepeatDirective = ["$parse", "$animate", "$compile", function($parse, $animate, $compile) {
        ...
        var updateScope = function(scope, index, valueIdentifier, value, keyIdentifier, key2, arrayLength) {
          ...
          if (keyIdentifier) scope[keyIdentifier] = key2;
          scope.$index = index;
          scope.$first = index === 0;
          ...
          compile: function ngRepeatCompile($element, $attr) {
            ...
            if (trackByExp) {
              ...
              trackByIdExpFn = function($scope, key2, value, index) {
                if (keyIdentifier) hashFnLocals[keyIdentifier] = key2;
...
export default require_angular2();
